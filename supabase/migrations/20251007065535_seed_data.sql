...
INSERT INTO products (id, title, slug, codes, sku, category_id, price, mrp, tax_slab, hsn_code, stock, images, description, featured) VALUES
  ...
  ('33333333-3333-3333-3333-333333333338', 'Bandhani Saree - Purple', 'bandhani-saree-purple', ARRAY['BDP008', 'PURPLE-BAN-08'], 'SKU-BDP008', '11111111-1111-1111-1111-111111111114', 3999, 5999, 5, '5407', 15, ARRAY['https://images.pexels.com/photos/1134282/pexels-photo-1134282.jpeg'], 'Traditional Rajasthani bandhani saree in royal purple.', false)
ON CONFLICT (id) DO NOTHING;

-- Insert Sample Products - Jewellery
INSERT INTO products (id, title, slug, codes, sku, category_id, price, mrp, tax_slab, hsn_code, stock, images, description, featured) VALUES
  ('44444444-4444-4444-4444-444444444441', 'Gold Plated Ring - Floral Design', 'gold-plated-ring-floral', ARRAY['GPR001', 'RING-FLO-01'], 'SKU-GPR001', '22222222-2222-2222-2222-222222222222', 1299, 1999, 3, '7113', 30, ARRAY['https://images.pexels.com/photos/1120597/pexels-photo-1120597.jpeg'], 'Beautiful gold plated ring with intricate floral design.', true),
  ...
  ('44444444-4444-4444-4444-444444444444', 'Gold Chain - Delicate', 'gold-chain-delicate', ARRAY['GCD004', 'CHAIN-DEL-04'], 'SKU-GCD004', '22222222-2222-2222-2222-222222222223', 4999, 6999, 3, '7113', 18, ARRAY['https://images.pexels.com/photos/1120597/pexels-photo-1120597.jpeg'], 'Delicate gold chain suitable for pendants and everyday elegance.', false),
